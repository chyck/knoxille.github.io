    ...
    this.FilmRoll = (function() {
        ...
        FilmRoll.prototype.configure = function() {
            ...
            if (!(this.options.no_css === true || document.film_roll_styles_added)) {
                $("<style type='text/css'> .film_roll_wrapper{display:block;text-align:center;float:none;position:relative;top:auto;right:auto;bottom:auto;left:auto;z-index:auto;width:100%;height:100%;margin:0 !important;padding:0 !important;} .film_roll_shuttle{text-align:left;float:none;position:absolute;top:0;left:0;right:auto;bottom:auto;height:100%;margin:0 !important;padding:0 !important;z-index:50;} .film_roll_shuttle.vertical_center:before{content:'';display:inline-block;height:100%;vertical-align:middle;margin-right:-0.25em;} .film_roll_child{position:relative;display:inline-block;*display:inline;vertical-align:middle;zoom:1;overflow: hidden;height: 400px;}.film_roll_pager{text-align:center;display: none;} .film_roll_pager a{width:5px;height:5px;border:2px solid #333;border-radius:5px;display:inline-block;margin:0 5px 0 0;transition:all 1s ease} .film_roll_pager a:hover{background:#666} .film_roll_pager a.active{background:#333;}.trx-gallery #film_roll div.active{height: 480px} </style>").appendTo('head');
            ...
            this.children.each((function(_this) {
                return function(i, e) {
                    ...
                    $el.addClass("film_roll_child").click(function (ev) {
                        ev.preventDefault();
                    });
